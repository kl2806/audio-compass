...
public class Lesson1 {
  ...
  FloatBuffer sourcePos = (FloatBuffer)BufferUtils.createFloatBuffer(3).put(new float[] { 0.0f, 10.0f, 10.0f }).rewind();
  ...
  */
  int loadALData() {
    ...
    WaveData waveFile = WaveData.create("audio/laughfuzzball.wav");
